...
export const T: Record<Lang, TranslationKeys> = {
  en: {
    ...
    cta_badge:'Built for Hackathon 2025', cta_title:'Ready to optimize your payments?',
    ...
    footer_sub:'Cross-border payment intelligence for SMEs. Hackathon 2025.',
  ...
  yo: {
    ...
    cta_badge:'A Kọ Fún Hackathon 2025', cta_title:'Ṣé o ṣetán láti ṣe àmúnibọ̀wọ̀ ìsanpá rẹ?',
    ...
    footer_sub:'Ìmọ̀ ìsanpá àgbáyé fún àwọn SME. Hackathon 2025.',
  ...
  ha: {
    ...
    cta_badge:'An gina don Hackathon 2025', cta_title:'Kana shirye don inganta biyan kuɗinka?',
    ...
    footer_sub:'Hankali na biyan kuɗi na ƙasashen waje don ƴan kasuwa. Hackathon 2025.',
  ...
  ar: {
    ...
    cta_badge:'مبني لـ Hackathon 2025', cta_title:'هل أنت مستعد لتحسين مدفوعاتك؟',
    ...
    footer_sub:'ذكاء المدفوعات العابرة للحدود للشركات الصغيرة. Hackathon 2025.',
  ...
  fr: {
    ...
    cta_badge:'Conçu pour Hackathon 2025', cta_title:'Prêt à optimiser vos paiements ?',
    ...
    footer_sub:'Intelligence de paiement transfrontalier pour PME. Hackathon 2025.',
